function updateNotesTable(noteId, noteTitle) {
    ...
    getNotes(noteTitle).then(data => {
        data.forEach(note => {
            ...
            cell4.innerHTML = `<a onclick="openEditModal('${note["_id"]}')" href="#"><img src="imges/edit_icon-icons.com_52382.png" style="width: 22px;"></a>
                               <a onclick="confirmDeleteNote('${note["_id"]}')" href="#"><img src="imges/1486504830-delete-dustbin-empty-recycle-recycling-remove-trash_81361.png" style="width: 22px;"></a>`
        })
    }).then(() => {
        if (noteId) {
